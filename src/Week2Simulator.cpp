...
Week2Simulator::Week2Simulator() = default;
 ...
 */
void Week2Simulator::runSimulation(ParticleContainer& particleContainer, double& end_time, double& delta_t, double& epsilon, double& sigma) {
  //setting up
